        ...
        <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
          {categories.map((category, index) => (
            <Link
              ...
              className="group flex flex-col items-center gap-3 rounded-xl border border-navy-100 p-5 text-center transition-colors hover:border-navy-300 hover:bg-navy-50"
            >
